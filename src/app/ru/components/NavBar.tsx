...
export default function NavBar() {
  return (
    <div className="fixed top-0 z-50 w-full bg-gradient-to-b from-black/90 via-black/70 to-transparent pt-4 pb-12">
      <nav className="flex w-full items-center justify-center gap-12 px-6 py-4 text-lg">
        ...
        <Link href="/ru/about" className="transition-opacity hover:opacity-70">
          О системе
        </Link>
        <Link href="/ru/notes" className="transition-opacity hover:opacity-70">
          Заметки
        </Link>
        <Link href="/ru/patch-notes" className="transition-opacity hover:opacity-70">
          Примечания к патчам
        </Link>
        <Link href="/ru/plan" className="transition-opacity hover:opacity-70">
          План
        </Link>
